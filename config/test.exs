...
config :capway_sync,
  ...
  capway_creditor: System.get_env("CAPWAY_CREDITOR") || "202623",
  # Snapshot-shrink guard tolerance (fraction); tests override per case
  capway_snapshot_drop_tolerance: 0.05,
